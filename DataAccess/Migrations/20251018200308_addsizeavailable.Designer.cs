...
namespace DataAccess.Migrations
{
    ...
    [Migration("20251018200308_addsizeavailable")]
    partial class addsizeavailable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Entities.ClassRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataAccess.Entities.ClassSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataAccess.Entities.DoctorCourse", b =>
                {
                    b.Property<Guid>("DoctorId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataAccess.Entities.Faculty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataAccess.Entities.RegistrationPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataAccess.Entities.ClassRegistration", b =>
                {
                    b.HasOne("DataAccess.Entities.Class", "Class")
                        .WithMany("StudentRegisterations")
                        .HasForeignKey("ClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccess.Entities.RegistrationPeriod", "RegistrationPeriod")
            ...
            modelBuilder.Entity("DataAccess.Entities.Department", b =>
                {
                    b.HasOne("DataAccess.Entities.Faculty", "Faculty")
            ...
            modelBuilder.Entity("DataAccess.Entities.Doctor", b =>
                {
                    b.HasOne("DataAccess.Entities.Faculty", null)
                        .WithMany("Doctors")
                        .HasForeignKey("FacultyId");
